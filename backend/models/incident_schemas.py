...
location precision, danger-zone boundaries, operator confirmations, and AIS correlation.
"""
...
class NearbyVesselRisk(BaseModel):
    ...
    risk_level: str = Field(default="MONITORED", description="DANGER, WARNING, or MONITORED")


class Incident(BaseModel):
    """Normalized Maritime Incident with multi-source citations and spatial intelligence."""
    incident_id: str
    title: str
