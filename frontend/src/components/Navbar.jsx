    ...
    <header className="border-b border-ocean-850 bg-ocean-900/90 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4 text-xs font-mono">
          {/* Backend Status */}
          <div className="flex items-center space-x-2 px-3 py-1.5 rounded-md bg-ocean-850 border border-ocean-700">
          ...
          <div className={`flex items-center space-x-2 px-3 py-1.5 rounded-md border ${
            ...
            <span className="font-semibold">
              {isSonarTrained ? 'Sonar Checkpoint' : 'Base Architecture'}
            </span>
          </div>
        </div>
      </div>
